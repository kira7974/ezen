...
public class BoardController {
	...
	public ModelAndView processMyBoard(@RequestParam(value="pageNum",defaultValue="1")int currentPage, HttpSession session) {
		...
		PagingUtil page = new PagingUtil(currentPage,count,10,10,"myBoard.do");
		map.put("start", page.getStartCount());
		map.put("end", page.getEndCount());

		List<BoardVO> list = null;
		if(count > 0) {
			list = boardService.selectListMember(map);
