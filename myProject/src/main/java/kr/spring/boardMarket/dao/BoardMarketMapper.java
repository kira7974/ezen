...
public interface BoardMarketMapper {
	...
	@Select("SELECT COUNT(*) FROM board_market b JOIN spmember m ON b.mem_num = m.mem_num")
	...
	@Select("SELECT * FROM board_market b JOIN spmember m ON b.mem_num=m.mem_num WHERE b.market_num=#{market_num}")
