...
<div class="page-main-style">
	<form:form commandName="boardQAVO" action="writeQA.do" enctype="multipart/form-data" cssClass="board_form_write" id="writeQA">
		...
		<ul>
			...
			<li>
				...
				No<form:radiobutton path="qa_secret" value="no" lable="NO" id="qa_secret" name="qa_secret"/>
				Yes<form:radiobutton path="qa_secret" value="yes" lable="YES" id="qa_secret" name="qa_secret"/>
			</li>
		</ul>
