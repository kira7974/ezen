...
<div class="page-main-style">
	...
	<div class="align-right view_btn_modi_del">
		<%--수정 삭제의 경우는 로그인이 되어있고 로그인한 회원번호와 작성자 회원번호가
	               일치해야 함 --%>
		<input type="button" value="목록" onclick="location.href='list.do'" class="btn btn-success">
		<c:if test="${!empty user && user.mem_num == board.mem_num}">
		<input type="button" value="수정" onclick="location.href='update.do?board_num=${board.board_num}'" class="btn btn-info">
	...
	<div class="page-main-style">
		<form method="post" class="coment_width" id="reply_form">
		    ...
		    <ul>
				...
				<li>
					<textarea rows="5" cols="100" id="free_com_content" class="form-control"></textarea>
				</li>
		    </ul>
