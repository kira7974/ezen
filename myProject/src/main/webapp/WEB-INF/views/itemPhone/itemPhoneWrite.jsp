...
<div class="page-main-style">
	<form:form commandName="itemPhoneVO" action="writePhone.do" enctype="multipart/form-data" cssClass="board_form_write" id="write_Phone">
		<form:errors element="div" cssClass="error-color"/>
		<ul>
			<li>
				<label for="name">스마트폰 기종</label>
