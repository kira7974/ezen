...
<div class="page-main-style">
	...
	<hr size="1" width="100%">
	<c:if test="${!empty notcie.notice_filename}">
	<div class="align-center">
		<img src="imageView.do?board_num=${notice.notice__num}" style="max-width:500px;" class="img_center">
	</div>
	</c:if>
	...
	<div class="align-right view_btn_modi_del">
		...
		<input type="button" value="수정" onclick="location.href='updateNotice.do?notcie_num=${notcie.notice_num}'">
		...
		<script>
			...
			delete_btn.onclick=function(){
				...
				if(choice){
					location.href='deleteNotcie.do?board_num=${notcie.notcie_num}';
				}
			};
		</script>              
		</c:if>
